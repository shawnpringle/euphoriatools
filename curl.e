public include _curl.e as p
include std/machine.e
include std/types.e

public type enum CURLcode
   CURLE_OK = 0,
...
public type enum curl_proxytype  /* this enum was added in 7.10 */
...
constant CURLOPT_LASTENTRY = CURLOPT_MAIL_RCPT_ALLLOWFAILS + 1
public type CURLoption(object x)
	if not integer(x) then
		return 0
	end if
	return x >= 0 and x < CURLOPT_LASTENTRY
end type
